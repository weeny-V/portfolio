...
const Mongodb = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" {...props}>
    ...
    <path
      ...
      style={{
        fill: "url(#mongodb-gradient-stem)",
      }}
    />
    <path
      ...
      style={{
        fill: "url(#mongodb-gradient-right)",
      }}
    />
    <path
      ...
      style={{
        fill: "url(#mongodb-gradient-left)",
      }}
    />
  </svg>
)
